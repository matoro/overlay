...
BDEPEND=">=dev-util/rocm-cmake-5.3
	...
	"
PATCHES=( "${FILESDIR}/767241dca886bcd2469d91382afab9d032e1cfa6.patch" )
...
src_prepare() {
	...
	eapply "${FILESDIR}/ca70cd7c3d63b1036e604116f3b269ca123e7904.patch"
	eapply "${FILESDIR}/0001-Revert-SWDEV-325538-Enable-code-object-v5-by-default.patch"
	popd || die
}
