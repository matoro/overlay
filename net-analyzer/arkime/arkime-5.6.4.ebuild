...
SRC_URI="https://github.com/arkime/arkime/archive/refs/tags/v${PV}.tar.gz -> ${P}.tar.gz
	viewer? ( https://github.com/gchq/CyberChef/releases/download/v10.19.2/CyberChef_v10.19.2.zip )"
...
DEPEND="
	...
	viewer? ( >=net-libs/nodejs-20.18.3[npm] <net-libs/nodejs-21:=[npm] )
	parliament? ( >=net-libs/nodejs-20.18.3[npm] )
	wise? ( >=net-libs/nodejs-20.18.3[npm] )
"
...
RDEPEND="${DEPEND}
	...
	viewer? ( >=net-libs/nodejs-20.18.3 <net-libs/nodejs-21:= )
	parliament? ( >=net-libs/nodejs-20.18.3 )
	wise? ( >=net-libs/nodejs-20.18.3 )
"
