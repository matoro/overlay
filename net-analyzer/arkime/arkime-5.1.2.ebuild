...
SRC_URI="https://github.com/arkime/arkime/archive/refs/tags/v${PV}.tar.gz -> ${P}.tar.gz
	viewer? ( https://github.com/gchq/CyberChef/releases/download/v10.17.0/CyberChef_v10.17.0.zip )"
...
DEPEND="
	...
	viewer? ( >=net-libs/nodejs-18.20.2[npm] <net-libs/nodejs-19:=[npm] )
	parliament? ( >=net-libs/nodejs-18.20.2[npm] )
	wise? ( >=net-libs/nodejs-18.20.2[npm] )
"
...
RDEPEND="${DEPEND}
	...
	viewer? ( >=net-libs/nodejs-18.20.2 <net-libs/nodejs-19:= )
	parliament? ( >=net-libs/nodejs-18.20.2 )
	wise? ( >=net-libs/nodejs-18.20.2 )
"
