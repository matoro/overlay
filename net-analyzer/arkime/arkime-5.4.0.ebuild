...
DEPEND="
	...
	viewer? ( >=net-libs/nodejs-20.15.1[npm] <net-libs/nodejs-21:=[npm] )
	parliament? ( >=net-libs/nodejs-20.15.1[npm] )
	wise? ( >=net-libs/nodejs-20.15.1[npm] )
"
...
RDEPEND="${DEPEND}
	...
	viewer? ( >=net-libs/nodejs-20.15.1 <net-libs/nodejs-21:= )
	parliament? ( >=net-libs/nodejs-20.15.1 )
	wise? ( >=net-libs/nodejs-20.15.1 )
"
