...
src_prepare() {
	...
	# bump sqlite3 to 4.0.8
	sed -i "s/\"sqlite3\": \"^4.0.2\"/\"sqlite3\": \"^4.0.8\"/g" "package.json" || die
	...
	# fix for >=net-libs/nodejs-10
	# ref on this change: https://github.com/osmcode/node-osmium/pull/99/files
	# https://github.com/matoro/node-iptrie/commit/41efa19f8e808b9e95d4cb5820f7cc6acdb9ed7e
	# https://github.com/aol/moloch/issues/526#issuecomment-473271941
	sed -i "s/github.com\/postwait\/node-iptrie/github.com\/matoro\/node-iptrie/g" "wiseService/package.json" || die
	npm -C "wiseService" install --package-lock-only || die
