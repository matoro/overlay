...
IUSE="acme consent jwt ldap mail oidc opentracing postgres redis saml sentry +sqlite systemd test urlpreview"
# postgres tests run only against prod instance or docker
RESTRICT="mirror postgres? ( test )"

# https://github.com/matrix-org/synapse/pull/7602
...
# https://github.com/matrix-org/synapse/pull/8011
...
RDEPEND=">=dev-python/jsonschema-2.5.1[${PYTHON_USEDEP}]
		...
		>=dev-python/canonicaljson-1.2.0[${PYTHON_USEDEP}]
