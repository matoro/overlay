...
IUSE="cache_memory jwt ldap mail oidc opentracing postgres redis saml sentry +sqlite systemd test urlpreview"
RESTRICT="mirror"
...
# https://github.com/matrix-org/synapse/pull/12667
...
RDEPEND="acct-user/synapse
		...
		>=dev-python/pillow-5.4.0[${PYTHON_USEDEP},jpeg,jpeg2k,webp]
		...
		cache_memory? ( dev-python/Pympler[${PYTHON_USEDEP}] )"
DEPEND="${RDEPEND}
